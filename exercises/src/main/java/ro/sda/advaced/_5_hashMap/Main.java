package ro.sda.advaced._5_hashMap;
/*
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        manager.addStock(new StockItem("salad",1.5, 40));
        manager.addStock(new StockItem("coffee",16.5, 200));
        manager.addStock(new StockItem("iPhone",5000, 10));
